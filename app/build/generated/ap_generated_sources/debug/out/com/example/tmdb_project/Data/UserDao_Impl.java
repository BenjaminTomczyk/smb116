...
public final class UserDao_Impl implements UserDao {
  ...
  public List<User> getAll() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item.setBirthdate(_tmpBirthdate);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  @Override
  public Integer checkUser(final String email, final String password) {
    final String _sql = "SELECT Count(*) FROM User WHERE email = ? AND password = ?";
